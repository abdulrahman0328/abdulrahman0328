...
Role        : Accounting & Data Analysis Specialist
Education   : B.Com. Accounting — Beni-Suef University (Very Good / High Honors)
              🏆 1st Rank University-Wide · Final Year · 94%
Location    : Egypt 🇪🇬
Languages   : Arabic (Native)  |  English (Very Good)
Status      : 🟢 Open to Work — Freelance & Full-time Opportunities
```
...
|---|---------|-------|------------|
| 🥇 | **[Data Science Salary Dashboard](https://mostaql.com/portfolio/3116866-data-science-salary-dashboard)** | Excel · MEDIANIFS · Pivot Tables | 32,600+ rows · 3 dynamic filters · KPI cards |
| 🥈 | **[Social Reports Automation](https://mostaql.com/u/Abdulrahman677/portfolio)** | Excel VBA · Data Migration | ↓40% manual time · one-click automation |
...
| 📊 | **[Data Science Job Market Analysis](https://sites.google.com/view/abdu-datanerd/project-page/4)** | Power Query · DAX · Power Pivot | Skills ↔ salary correlation · top-10 skills |
| 📈 | **[BM Company Sales Dashboard 2010–2024](https://sites.google.com/view/abdu-datanerd/project-page/5)** | Excel · SUMIFS · MEDIANIFS | ~50,000 rows · 14 years · formula-only |

> 📌 More projects coming soon as repos are uploaded!
...
🎓  B.Com. Accounting (English Section)
    ...
    Grade: Very Good (High Honors)  ·  Final Year Rank: 1st / 94%
...
**🏦 Trainee — CIB Bank** *(Aug 2024)*
> Data literacy · banking data analysis · trend identification · decision-support reporting

**💻 Freelancer — Mostaql Platform**
> Excel VBA automation · financial dashboards · data analysis · client reporting

**🤝 HR Member — Enactus Beni-Suef** *(Mar 2022 – May 2023)*
> Project management · HRM · presentations · team evaluation & development
...
- 📊 **Advanced Power BI** — complex DAX, Row-Level Security, data modeling
- 🐍 **Python for Data Analysis** — pandas, matplotlib, financial automation
- ☁️ **Cloud & BI Tools** — exploring modern data stack
